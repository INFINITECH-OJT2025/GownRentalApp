...
//                 console.error(`⚠ Fetch Customers Error: HTTP Status ${customersResponse.status}`);
//                 alert("Please Check your internet! Thank You!");
...
//                 console.error(`⚠ Fetch Unread Customers Error: HTTP Status ${unreadResponse.status}`);
//                 alert("Please Check your internet! Thank You!");
//                 return; // Prevent further execution
//             }
